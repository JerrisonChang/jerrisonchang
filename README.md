...
_Senior Software Engineer/Developer_ @ Health Research, Inc.

_PHD candidate_ @ [University at Albany](https://www.albany.edu/)
...
```typescript
const Jerrison: Person & SoftwareEngineer = {
    pronoun: "he/him",
    programmingSkills: {
        Python: [Flask, pandas, numpy, scikit-learn, nltk, spacy, PyQt5],
        JavaScript: [NodeJS, ExpressJS, AngularJS & Angular, ReactJS, cytoscapejs],
        Typescript: [],
        Java: [],
    },
    ...
    hobbies: [bodyBuilding, hiking, videoGames, sewing, digitalDrawing]
};
```
